...
From one side it is greatly filled with a lot of technical details and still extended, but from the other the content is not always universal and some pages are lying not maintained.\\
...
\begin{itemize}
  \item \url{https://en.wikipedia.org/wiki/Category:Embedded_Linux}
  \item \url{http://dbpedia.org/page/Category:Embedded_Linux}
  \item \url{https://en.wikipedia.org/wiki/Linux_on_embedded_systems}
  \item \url{http://dbpedia.org/page/Linux_on_embedded_systems}
  \item \url{https://en.wikipedia.org/wiki/OpenEmbedded}
  \item \url{https://en.wikipedia.org/wiki/List_of_build_automation_software}
