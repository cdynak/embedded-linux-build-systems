...
% TODO: build system (in general) definition
...
% What is required on host before installing LTIB
...
% Horrible, awkward situation - like need to call a~special service to fix a hammer, instead of making it at home.
...
\begin{figure}[htbp]
  ...
  \label{fig:5-web}
\end{figure}
% convert 5.png -crop 90%x+300+25 5-web.png
...
\begin{figure}[htbp]
  ...
  \label{fig:6-web}
\end{figure}
% convert 6.png -crop 90%x+300+25 6-web.png
...
% containers implementation comparison - there are many scientific papers with comparison (mostly about performance)

% TODO: \subsection*{Node.js container}

% alpine linux (musl) / debian-based nodejs containers performance case
...
% http://henryomd.blogspot.com/2017/12/xenomai-on-raspberry-pi.html


%>>> linux 7dc3bd00d62130ef7f09759a8c0ec9d65f58c987 Extracting
%gzip -d -c /home/cdynak/buildroot-2017.11.1/dl/linux-7dc3bd00d62130ef7f09759a8c0ec9d65f58c987.tar.gz | tar --strip-components=1 -C /home/cdynak/buildroot-2017.11.1/output/build/linux-7dc3bd00d62130ef7f09759a8c0ec9d65f58c987   -xf -
%>>> linux 7dc3bd00d62130ef7f09759a8c0ec9d65f58c987 Patching
%/home/cdynak/buildroot-2017.11.1/output/build/xenomai-3.0.6/scripts/prepare-kernel.sh --linux=/home/cdynak/buildroot-2017.11.1/output/build/linux-7dc3bd00d62130ef7f09759a8c0ec9d65f58c987 --arch=arm --default --verbose
%Preparing kernel 4.9.52 in /home/cdynak/buildroot-2017.11.1/output/build/linux-7dc3bd00d62130ef7f09759a8c0ec9d65f58c987...
